...
void rtc_reg_report (void) {
   printf("RTC_TSR    = 0x%02X,    ",    ((unsigned int) RTC_TSR)) ;
  printf("RTC_TPR    = 0x%02X\n",       ((unsigned int) RTC_TPR)) ;
  printf("RTC_TAR    = 0x%02X,    ",    ((unsigned int) RTC_TAR)) ;
  printf("RTC_TCR    = 0x%02X\n",       ((unsigned int) RTC_TCR)) ;
  printf("RTC_CR     = 0x%02X,    ",    ((unsigned int) RTC_CR)) ;
  printf("RTC_SR     = 0x%02X\n",       ((unsigned int) RTC_SR)) ;
  printf("RTC_LR     = 0x%02X,    ",    ((unsigned int) RTC_LR)) ;
